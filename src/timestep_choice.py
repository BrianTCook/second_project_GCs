...
for i, dt in enumerate(dt_values):
    ...
    plt.plot(sim_times, energies, linewidth=0.5, label=r'$\Delta t$ = %.03f Myr'%(dt))
...
plt.annotate(r'$\log_{2}N_{\mathrm{clusters}}=0$', xy=(0.05,0.1), xycoords='axes fraction', fontsize=8)
